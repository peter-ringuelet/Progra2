...
var aux: arbol; min: integer;
begin
    if(a = nil) then writeln('El elemento a borrar no se encontro')
    else
    begin
        if (a^.dato > dato) then borrarElemento(a^.HI,dato)
            else if (a^.dato < dato) then borrarElemento(a^.HD,dato)
